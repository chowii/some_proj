 ...
 */
@Entity(tableName = SohoDatabase.TABLE_MARKET_PLACE_FILTER)
data class MarketplaceFilter(
        ...
        var orderByType: String = Keys.OrderBy.LISTED_AT,
        var orderDirection: String = Keys.OrderDirection.DESCENDING) {
    ...
    @Ignore
    constructor() : this(0, false, MarketplaceFilterSaleType.SALE, RentPaymentFrequency.WEEKLY
            , DEFAULT_RADIUS, ArrayList<String>(), 0, 0, 0, 0, DEFAULT_BEDROOMS, 0.0, 0.0, true
            , Keys.OrderBy.LISTED_AT, Keys.OrderDirection.DESCENDING)
